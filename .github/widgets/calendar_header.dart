...
class CalendarHeader extends StatelessWidget {
  ...
  final Function(String) onWeekTypeChanged;
  ...
  Widget _buildWeekTypeSelector() {
    return Container(
      ...
      child: Row(
        children: [
          _buildWeekTypeOption(AppConstants.weekA, 'Week A'),
          _buildWeekTypeOption(AppConstants.weekB, 'Week B'),
        ],
      ),
    );
  }
  ...
  Widget _buildWeekTypeOption(String weekType, String label) {
